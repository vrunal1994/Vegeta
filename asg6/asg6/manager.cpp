  ...
  frameMax( Gamedata::getInstance().getXmlInt("frameMax") )
{
  ...
  {dragonBalls.push_back(new SmartSprite("dragonball"));
    //static_cast<Vegeta*>(sprites[1]) -> attach(static_cast<SmartSprite*>(sprites[i]));
  }
  ...
  ++str;}
// SmartSprite* ss =
  //      new SmartSprite("dragonball");
    //  sprites.push_back(ss);
      //static_cast<Vegeta*>(sprites[2])->attach(ss);
  ...
  //static SDLSound sound;
   ...
   std::list<smallSprite>::const_iterator pls = vegeta->bullets.bulletList.begin();
    ...
    {     SmartSprite* ss=dynamic_cast<SmartSprite*>(*sprite);
      // ExplodingSprite* e = dynamic_cast<SmartSprite*>(*sprite);
