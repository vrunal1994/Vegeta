...
public:
  ...
  virtual void draw() const = 0;        // abstract function pure virtual
  virtual void update(Uint32 ticks) = 0; // abstract function pure virtual
  virtual void toggleLeft(){}
  virtual void toggleRight(){}
