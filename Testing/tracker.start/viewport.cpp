...
Viewport::Viewport() : 
  ...
  midWidth(Gamedata::getInstance().getXmlInt("mid/width")),
  midHeight(Gamedata::getInstance().getXmlInt("mid/height")),
...
void Viewport::update() {
 ...
 /* if (position[0] > (midWidth - viewWidth)) {
    position[0] = midWidth-viewWidth;
  }
  if (position[1] > (midHeight - viewHeight)) {
    position[1] = midHeight-viewHeight;
  }*/
}
